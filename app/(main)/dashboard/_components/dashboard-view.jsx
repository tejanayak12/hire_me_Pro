...
import { ResponsiveContainer, BarChart, XAxis, YAxis, Tooltip, Bar, CartesianGrid, Rectangle } from 'recharts';
        ...
        <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className={`h-2 w-full rounded-full mt-2 ${getDemandLeveColor(
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Displaying mimimum, median, and maximum salaries (in thousands)
                    </CardDescription>
                </CardHeader>
                <CardContent>
