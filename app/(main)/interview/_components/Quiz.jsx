...
const Quiz = () => {
    ...
    const finishQuiz = async () => {
        const score = calculateScore(); // Fix function call
        if (!quizData || !answers) {
        ...
        try {
            await saveQuizResultFn({ questions: quizData, answers, score }); // Pass as object
    ...
    const startNewQuiz = () => {
        ...
        generateQuizfn(); // Correct function call
    };
    ...
    return (
        <Card className="mx-2">
            ...
            <CardContent className="space-y-4">
                ...
                {showExplanation && <div className="mt-4 p-4 bg-muted">
            ...
            <CardFooter>
                ...
                >
                    {savingResult && (
                        <BarLoader className='mt-4' width={"100%"} color='grey' />
                    )}
